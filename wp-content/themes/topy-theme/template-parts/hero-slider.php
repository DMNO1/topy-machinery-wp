    ...
    <div class="slider-container">
        ...
        <div class="slide active">
            ...
            <div class="slide-content">
                ...
                <a href="/products/vffs" class="btn btn-primary">More related products →</a>
            </div>
        </div>
        ...
        <div class="slide">
            ...
            <div class="slide-content">
                ...
                <a href="/products" class="btn btn-primary">Explore Machines →</a>
            </div>
        </div>
        ...
        <div class="slide">
            ...
            <div class="slide-content">
                ...
                <a href="/products" class="btn btn-primary">Explore Food Packing Machines →</a>
            </div>
        </div>
